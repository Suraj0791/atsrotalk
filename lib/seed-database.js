...
const products = [
  {
    ...
    price: 1299.99,
    // Added more URLs for demonstration
    image_urls: [
        "https://images.unsplash.com/photo-1568219656418-15c329312bf1?auto=format&fit=crop&w=800&q=80",
        "https://images.unsplash.com/photo-1518099074172-2e47ee6cfdc0?auto=format&fit=crop&w=800&q=80", // Moon hanging
        "https://images.unsplash.com/photo-1615484477778-ca3b77940c25?auto=format&fit=crop&w=800&q=80" // Gemstones
    ],
  ...
  },
  {
    ...
    image_urls: [
        ...
        "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=800&q=80" // Earrings
    ],
  ...
  },
  {
    ...
    image_urls: [
        ...
        "https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&w=800&q=80" // Library
    ],
  ...
  },
  {
    ...
    price: 899.99,
    image_urls: ["https://images.unsplash.com/photo-1518099074172-2e47ee6cfdc0?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 25,
    featured: true,
  },
  {
    ...
    price: 349.99,
    image_urls: ["https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 75,
    featured: false,
  },
  {
    ...
    price: 4999.99,
    image_urls: ["https://images.unsplash.com/photo-1566004100631-35d015d6a491?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'special', // Added category
    stock: 5,
    featured: true,
  },
  {
    ...
    price: 599.99,
    image_urls: ["https://images.unsplash.com/photo-1602523961358-f9f03dd557db?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'package', // Added category
    stock: 30,
    featured: false,
  },
  {
    ...
    price: 249.99,
    image_urls: ["https://images.unsplash.com/photo-1563911892437-1feda0179e1b?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 60,
    featured: false,
  },
  {
    ...
    price: 799.99,
    image_urls: ["https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 20,
    featured: false,
  },
  {
    ...
    price: 399.99,
    image_urls: ["https://images.unsplash.com/photo-1536623975707-c4b3b2af565d?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 40,
    featured: false,
  },
  {
    ...
    price: 1499.99,
    image_urls: ["https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'package', // Added category
    stock: 15,
    featured: false,
  },
  {
    ...
    price: 199.99,
    image_urls: ["https://images.unsplash.com/photo-1570211776045-af3a51026f4a?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 100,
    featured: false,
  },
  {
    ...
    price: 899.99,
    image_urls: ["https://images.unsplash.com/photo-1615484477778-ca3b77940c25?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'special', // Added category
    stock: 25,
    featured: true,
  },
  {
    ...
    price: 149.99,
    image_urls: ["https://images.unsplash.com/photo-1618424181497-157f25b6ddd5?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 200,
    featured: false,
  },
  {
    ...
    price: 2999.99,
    image_urls: ["https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'special', // Added category
    stock: 8,
    featured: false,
  },
  {
    ...
    price: 1999.99,
    image_urls: ["https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'special', // Added category
    stock: 50,
    featured: false,
  },
  {
    ...
    price: 349.99,
    image_urls: ["https://images.unsplash.com/photo-1568219656418-15c329312bf1?auto=format&fit=crop&w=800&q=80"], // Reusing image, replace if needed // Changed to image_urls array
    category: 'regular', // Added category
    stock: 35,
    featured: false,
  },
  {
    ...
    price: 699.99,
    image_urls: ["https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'package', // Added category
    stock: 40,
    featured: false,
  },
  {
    ...
    price: 999.99,
    image_urls: ["https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'special', // Added category
  ...
  },
  {
    ...
    price: 449.99,
    image_urls: ["https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=800&q=80"], // Changed to image_urls array
    category: 'regular', // Added category
    stock: 60,
    featured: false,
  },
