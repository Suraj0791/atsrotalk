...
const testimonials = [
  ...
  { quote: "सबसे अच्छा और भरोसेमंद जरूर खरीदे। धन्यवाद समाधान होगा", author: "रुशित कुमार" },
  ...
  { quote: "abhimantrit hanuman dhaga Great quality . Delivery was quick. Feeling the change in my life after wearing it. Really satisfied with the order. Just you guys need work on customer order tracking Id and else. Otherwise everything else is very good and smooth.", author: "shilpi thakur" },
  { quote: "Genuine Very best 100% original product. I liked it so much😊. I had ordered suraksha chakra prepaid and really this is original I'm very happy. I received this within 3 days from bluedart and also got a calendar. Thanks to samadhan hoga and team.", author: "sneha rastogi" },
  { quote: "product khreedne se pehele jo bhi mere doubts the wo sab samadhan hoga ki team ne callpr clear kr diye the support team is really nice love the service. thanku samadhan hoga and team .", author: "aditya bansal" },
...
const MovingTestimonialCarousel = () => {
  return (
    <section className="bg-gradient-to-r from-purple-100 to-indigo-100 py-12 overflow-hidden">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10 text-purple-900">Voices of Our Community</h2>
        <div className="relative w-full h-64"> {/* Adjust height as needed */}
          <div className="absolute top-0 left-0 w-full h-full flex items-center animate-marquee whitespace-nowrap">
            {duplicatedTestimonials.map((testimonial, index) => (
              <div key={index} className="inline-block bg-white p-6 rounded-lg shadow-lg mx-4 w-80 flex-shrink-0"> {/* Fixed width card */}
                <p className="text-gray-700 italic mb-4 text-sm whitespace-normal">&ldquo;{testimonial.quote}&rdquo;</p>
                <p className="text-right font-semibold text-purple-800">- {testimonial.author}</p>
              </div>
            ))}
          </div>
        </div>
